...
dr=0.04; %default values 0.02 0.04 0.08, controlling the number of spiral threads
nthread=12; %default 12
nbead=400;
netrange=99/100;
startspiral=20;
...
outputname=['intact' int2str(nthread) '_length_' int2str(nbead) '.data'];
outputnamexyz=['intact' int2str(nthread) '_length_' int2str(nbead) '.xyz'];
